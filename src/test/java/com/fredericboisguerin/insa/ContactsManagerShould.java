...
public class ContactsManagerShould {
    ...
    public void fail_if_no_name() throws InvalidContactNameException, InvalidEmailException, java.lang.Exception {
    ...
    @Test(expected = InvalidContactNameException.class)
    public void fail_if_name_is_empty() throws InvalidContactNameException, InvalidEmailException, java.lang.Exception {
        ContactsManager contactsManager = new ContactsManager();
        String emptyName = "";
    ...
    public void fail_if_email_is_not_valid() throws InvalidContactNameException, InvalidEmailException, java.lang.Exception {
        ContactsManager contactsManager = new ContactsManager();
